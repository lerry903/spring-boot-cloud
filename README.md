...
本项目是一个基于 Spring Boot1.x、Spring Cloud、Spring Oauth2 和 Spring Cloud Netflix 等框架构建的微服务项目。

- 源码地址
  - GitHub：https://github.com/lerry903/spring-boot-cloud
  - 码云：https://gitee.com/lerry903/spring-boot-cloud
